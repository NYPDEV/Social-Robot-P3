...
namespace SocialRobot.Application.SkypeApp
{
    ...
    {
        private string cmd;
        public SKYPE4COMLib.Skype sp;
        public SKYPE4COMLib.Command sp_Command;
        private int timeout;
        private bool UsingPolicyPower;

        public SkypeCall(string Cmd, int Timeout)
        {
            this.sp = (SKYPE4COMLib.Skype)Activator.CreateInstance(System.Type.GetTypeFromCLSID(new Guid("830690FC-BF2F-47A6-AC2D-330BCB402664")));
        ...
        public SkypeCall(string Cmd, int Timeout, string UsingPower)
        {
            this.sp = (SKYPE4COMLib.Skype)Activator.CreateInstance(System.Type.GetTypeFromCLSID(new Guid("830690FC-BF2F-47A6-AC2D-330BCB402664")));
            this.sp_Command = (SKYPE4COMLib.Command)Activator.CreateInstance(System.Type.GetTypeFromCLSID(new Guid("2DBCDA9F-1248-400B-A382-A56D71BF7B15")));
            this.cmd = Cmd;
