        ...
        public void NewsReadingFunction_Eng(string NewsType)
        {
            ...
            try
            {
                ...
                if (rssnewsnode != null)
                {
                    ...
                    //SRG.SRE_Speech.SpeakAsync(NewsTitleOrDescription);
                    ...
                    if (NewsTitleOrDescription != " .")
                    {
                        ...
                        SRG.SRE_Speech.SpeakAsync("Here's some " + NewsType + " news. " + NewsTitleOrDescription);
            ...
            {
                NewsTypeSuccess = false;
            }
        }

        public void NewsReadingFunction_Cn()
        {
            SRG.SRE_Speech.SelectVoice("Microsoft Huihui Desktop");
            ...
            if (rssnewsnode != null && flag_StartNewsReading == true && flag_speak_completed == true)
            {
                ...
                NewsTitleOrDescription += "</speak>";
                SRG.SRE_Speech.SpeakSsmlAsync(NewsTitleOrDescription);
